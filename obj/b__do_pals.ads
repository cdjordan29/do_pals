...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_do_pals" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#8d81ec98#;
   pragma Export (C, u00001, "do_palsB");
   ...
   u00021 : constant Version_32 := 16#da4d2671#;
   pragma Export (C, u00021, "ada__exceptionsB");
   u00022 : constant Version_32 := 16#4c8cceba#;
   ...
   u00045 : constant Version_32 := 16#8c490d02#;
   pragma Export (C, u00045, "system__address_imageS");
   u00046 : constant Version_32 := 16#ec78c2bf#;
   pragma Export (C, u00046, "system__img_unsB");
   u00047 : constant Version_32 := 16#86d7d04c#;
   pragma Export (C, u00047, "system__img_unsS");
   u00048 : constant Version_32 := 16#1923ecbb#;
   pragma Export (C, u00048, "system__unsigned_typesS");
   u00049 : constant Version_32 := 16#d7aac20c#;
   pragma Export (C, u00049, "system__ioB");
   u00050 : constant Version_32 := 16#b3e76777#;
   pragma Export (C, u00050, "system__ioS");
   u00051 : constant Version_32 := 16#cf909744#;
   pragma Export (C, u00051, "system__object_readerB");
   u00052 : constant Version_32 := 16#6942daaf#;
   pragma Export (C, u00052, "system__object_readerS");
   ...
   u00064 : constant Version_32 := 16#b1330297#;
   pragma Export (C, u00064, "interfaces__c_streamsS");
   u00065 : constant Version_32 := 16#931ff6be#;
   pragma Export (C, u00065, "system__exception_tracesB");
   u00066 : constant Version_32 := 16#097ab0a2#;
   pragma Export (C, u00066, "system__exception_tracesS");
   u00067 : constant Version_32 := 16#ce7de326#;
   pragma Export (C, u00067, "system__win32S");
   u00068 : constant Version_32 := 16#8c33a517#;
   pragma Export (C, u00068, "system__wch_conB");
   u00069 : constant Version_32 := 16#36d8b2ea#;
   pragma Export (C, u00069, "system__wch_conS");
   u00070 : constant Version_32 := 16#9721e840#;
   pragma Export (C, u00070, "system__wch_stwB");
   u00071 : constant Version_32 := 16#1bc99eeb#;
   pragma Export (C, u00071, "system__wch_stwS");
   u00072 : constant Version_32 := 16#a831679c#;
   pragma Export (C, u00072, "system__wch_cnvB");
   u00073 : constant Version_32 := 16#396f0819#;
   pragma Export (C, u00073, "system__wch_cnvS");
   u00074 : constant Version_32 := 16#ece6fdb6#;
   pragma Export (C, u00074, "system__wch_jisB");
   u00075 : constant Version_32 := 16#b91f1138#;
   pragma Export (C, u00075, "system__wch_jisS");
   u00076 : constant Version_32 := 16#41837d1e#;
   pragma Export (C, u00076, "system__stack_checkingB");
   u00077 : constant Version_32 := 16#a31afbd0#;
   pragma Export (C, u00077, "system__stack_checkingS");
   u00078 : constant Version_32 := 16#e2ea8656#;
   pragma Export (C, u00078, "ada__strings__mapsB");
   u00079 : constant Version_32 := 16#1e526bec#;
   pragma Export (C, u00079, "ada__strings__mapsS");
   u00080 : constant Version_32 := 16#4a6f6ca4#;
   pragma Export (C, u00080, "system__bit_opsB");
   u00081 : constant Version_32 := 16#0765e3a3#;
   pragma Export (C, u00081, "system__bit_opsS");
   u00082 : constant Version_32 := 16#92f05f13#;
   pragma Export (C, u00082, "ada__strings__maps__constantsS");
   u00083 : constant Version_32 := 16#5e196e91#;
   pragma Export (C, u00083, "ada__containersS");
   u00084 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00084, "ada__float_text_ioB");
   u00085 : constant Version_32 := 16#e61b3c6c#;
   pragma Export (C, u00085, "ada__float_text_ioS");
   u00086 : constant Version_32 := 16#d5bfa9f3#;
   pragma Export (C, u00086, "ada__text_ioB");
   u00087 : constant Version_32 := 16#c3f01c15#;
   ...
   u00100 : constant Version_32 := 16#8ad4715d#;
   ...
   u00103 : constant Version_32 := 16#6257e3a8#;
   pragma Export (C, u00103, "system__finalization_rootS");
   u00104 : constant Version_32 := 16#9dd55695#;
   ...
   u00107 : constant Version_32 := 16#531a815e#;
   pragma Export (C, u00107, "system__stringsS");
   u00108 : constant Version_32 := 16#d03a0a90#;
   pragma Export (C, u00108, "system__file_control_blockS");
   u00109 : constant Version_32 := 16#d5f9759f#;
   pragma Export (C, u00109, "ada__text_io__float_auxB");
   u00110 : constant Version_32 := 16#f854caf5#;
   pragma Export (C, u00110, "ada__text_io__float_auxS");
   ...
   u00113 : constant Version_32 := 16#8aa4f090#;
   pragma Export (C, u00113, "system__img_realB");
   u00114 : constant Version_32 := 16#ea0dc1da#;
   pragma Export (C, u00114, "system__img_realS");
   u00115 : constant Version_32 := 16#29322bcb#;
   ...
   u00118 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00118, "system__img_lluB");
   u00119 : constant Version_32 := 16#50eaec78#;
   pragma Export (C, u00119, "system__img_lluS");
   u00120 : constant Version_32 := 16#7dd5f64f#;
   ...
   u00122 : constant Version_32 := 16#d38ce729#;
   pragma Export (C, u00122, "system__val_realS");
   u00123 : constant Version_32 := 16#6c05c057#;
   pragma Export (C, u00123, "system__exn_llfB");
   u00124 : constant Version_32 := 16#91db2be4#;
   pragma Export (C, u00124, "system__exn_llfS");
   u00125 : constant Version_32 := 16#75d08c2c#;
   pragma Export (C, u00125, "system__fat_fltS");
   u00126 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00126, "ada__integer_text_ioB");
   u00127 : constant Version_32 := 16#f1daf268#;
   pragma Export (C, u00127, "ada__integer_text_ioS");
   ...
   u00143 : constant Version_32 := 16#84a6e1b5#;
   ...
   u00145 : constant Version_32 := 16#3ea92e0b#;
   ...
   u00147 : constant Version_32 := 16#74d8f60c#;
